...
---------------------- INPUT FILES ---------------------------------------------
"CART3_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"CART3_Blades_V7.dat"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"CART3_Blades_V7.dat"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"CART3_Blades_V7.dat"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"CART3_InflowWind.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"CART3_AeroDyn14.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"CART3_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
