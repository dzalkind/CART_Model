...
"CART3_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
False         CalcSteady      - Calculate a steady-state periodic operating point before linearization? [unused if Linearize=False] (flag)
       ...
       1e-3   TrimTol         - Tolerance for the rotational speed convergence [used only if CalcSteady=True] (-)
